  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 1);borderRadius:10px">
        <h1 class="h1" style="color:rgba(128, 151, 186, 1);fontSize:28px;">校园闲置物品交易网站注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210223/1654336a4f7040be84651d5725f85f9c.jpg");
		height: 100vh;
